...
public class EmpleadosLista extends javax.swing.JDialog {
    ...
    public void recibeIdSucursal(int idSucursal){
        ...
        String queryEmpleados ="SELECT CONCAT (`nombreEmp`,' ', `apellidos`) AS nombreEmp FROM `empleado`";
    ...
    private void initComponents() {
        ...
        btnCancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/icon atras .png"))); // NOI18N
